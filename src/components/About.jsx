            ...
            <div className="container py-5 my-5">
                <div className="row">
                    <div className="col-md-6">
                        <h1 className="text-info fw-bold mb-4">About Us</h1>
                        ...
                        <NavLink to="/contact" className="btn btn-outline-info px-3 text-black">Contact Us</NavLink>
                    </div>
                    <div className="col-md-6 d-flex justify-content-center">
                        <img src="https://img.freepik.com/free-vector/teamwork-concept-landing-page_52683-20165.jpg?w=740&t=st=1684404348~exp=1684404948~hmac=8dd7aa7f84e79074467110fe02598a2f989e0803e7e2d5dd416d413e10200574" alt="About Us" height="400px" width="400px" />
                    </div>
                </div>
            </div>
        </div>
